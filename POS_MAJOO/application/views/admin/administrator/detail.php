    ...
    <div class="container-fluid">
        ...
        <div class="body">
            <ol class="breadcrumb">
                ...
                <li><a href="<?= base_url('') ?>">Administrator</a></li>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Detail <small>Informasi Detail</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="col">
                                <?php foreach ($user as $user) { ?>
                                    <img src="<?= base_url('./uploads/foto_user/') . $user->foto; ?>" alt="Foto Profil" class="logo mx-auto d-block mb-5 rounded-circle" width="200px">
                                    <div class="row">
